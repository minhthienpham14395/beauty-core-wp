...
<main class="page-content container">
    <nav class="breadcrumb" aria-label="Breadcrumb"><a href="<?php echo esc_url(beautycore_home_path()); ?>">Trang chủ</a><span aria-hidden="true">/</span><span>Giới thiệu</span></nav>
