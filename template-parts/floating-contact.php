...
<div class="floating-contact" aria-label="Liên hệ nhanh">
    <div class="ai-contact" id="ai-contact" data-zalo-url="<?php echo esc_url($config['zalo_url']); ?>" data-booking-url="<?php echo esc_url($config['booking_url']); ?>" data-phone="<?php echo esc_attr($config['phone']); ?>" data-map-url="<?php echo esc_url($config['google_map_url']); ?>">
