...
<section class="promotions-section" id="uu-dai"><div class="container">
    ...
    <div class="promotions-grid">
        <?php foreach ($promotions as $promotion) : ?><a href="<?php echo esc_url($config['booking_url']); ?>" class="promotion-card fade-in" aria-label="<?php echo esc_attr($promotion['alt']); ?> - Đặt lịch ngay"><img src="<?php echo esc_url(beautycore_asset_url($promotion['image'])); ?>" alt="<?php echo esc_attr($promotion['alt']); ?>" loading="lazy"><span>Đặt lịch ngay</span></a><?php endforeach; ?>
    </div>
</div></section>
