...
?>
<main class="page-content container"><nav class="breadcrumb" aria-label="Breadcrumb"><a href="<?php echo esc_url(beautycore_home_path()); ?>">Trang chủ</a><span aria-hidden="true">/</span><span>Câu hỏi thường gặp</span></nav><article><header class="page-header"><h1>Câu hỏi thường gặp</h1><p>Cập nhật: 13/07/2026</p></header>
