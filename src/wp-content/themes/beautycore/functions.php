...
define('BEAUTYCORE_VERSION', '1.2.6');
...
require_once BEAUTYCORE_THEME_DIR . '/inc/customer-voucher-review.php';
require_once BEAUTYCORE_THEME_DIR . '/inc/reports.php';
...
function beautycore_booking_section_url() {
    return beautycore_home_path() . '#dat-lich';
}
