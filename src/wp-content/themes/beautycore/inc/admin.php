...
define('BEAUTYCORE_ADMIN_VERSION', '1.6.0');
...
function beautycore_admin_role_capabilities() {
    return array(
        ...
        'export_beautycore_reports'     => true,
...
function beautycore_render_reports_page() {
    if (function_exists('beautycore_render_advanced_reports_page')) {
        beautycore_render_advanced_reports_page();
        return;
    }
    $metrics = beautycore_dashboard_metrics();
...
function beautycore_render_module_page() {
    ...
    } elseif ($slug === 'beautycore-customers' && function_exists('beautycore_stage5_render_customer_list')) {
        beautycore_stage5_render_customer_list();
    } elseif ($slug === 'beautycore-promotions' && function_exists('beautycore_stage5_render_voucher_list')) {
        beautycore_stage5_render_voucher_list();
    } elseif ($slug === 'beautycore-reviews' && function_exists('beautycore_stage5_render_review_list')) {
        beautycore_stage5_render_review_list();
