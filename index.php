...
get_header();
?>
<main class="page-content container"><nav class="breadcrumb" aria-label="Breadcrumb"><a href="<?php echo esc_url(home_url('/')); ?>">Trang chủ</a><span aria-hidden="true">/</span><span><?php echo esc_html(wp_get_document_title()); ?></span></nav><article>
